...
local function NewSandBox(fn)
    ...
    local env = {
        __loadonce = loadonce,
        __loaded = loaded,
        ModTextFileSetContent = nullfn,
        ModLuaFileSetAppends = nullfn,
        ModLuaFileAppend = nullfn,
        BiomeMapSetSize = nullfn,
        BiomeMapSetPixel = nullfn,
        BiomeMapGetPixel = function ()
            return 0
        end,
        BiomeMapConvertPixelFromUintToInt = function ()
            return 0
        end,
        BiomeMapLoadImage = nullfn,
        BiomeMapLoadImageCropped = nullfn,
    }
